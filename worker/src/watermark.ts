 ...
 *
 * Logs metrics: pagesCount, textLen, watermarkFilteredCount
 */

// Whitelist: if a line contains any of these substrings, NEVER remove it
const WHITELIST = [
  '€', 'euro', 'mq', 'm²', 'm2',
...
export function removeWatermarkLines(pages: string[]): WatermarkResult {
  ...
  // Log metrics (no document content)
  console.log(
